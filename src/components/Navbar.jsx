...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2 text-orange-500 font-extrabold'>
            Best <span>Eats</span>
        </h1>
        <div className='hidden lg:flex items-center bg-white shadow-lg shadow-gray-400 rounded-full p-1 text-[14px]'>
        ...
        {/* side menu */}
        <div className={nav ? 'fixed top-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}>
